...
export default function GroupRoomError({
  error,
  reset,
}: {
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      <div className="max-w-md w-full text-center">
        ...
        <h1 className="text-2xl font-bold text-white mb-2">Group Room Error</h1>
        <p className="text-gray-400 mb-6">Something went wrong loading the group room.</p>
