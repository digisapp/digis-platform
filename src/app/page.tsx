          ...
          <nav className="glass rounded-full px-6 md:px-8 py-4 mb-16 md:mb-24 max-w-4xl mx-auto flex items-center justify-between backdrop-blur-xl border-2 border-white/50 shadow-xl">
            ...
            <div className="flex items-center space-x-3 md:space-x-4">
              <button
                ...
                className="glass-hover glass px-4 md:px-6 py-2 md:py-2.5 rounded-full text-white font-bold text-sm md:text-base hover:scale-105 transition-all border-2 border-white/30"
              >
                Sign In
              </button>
              <button
