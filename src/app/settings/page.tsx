...
export default function SettingsPage() {
  ...
  const handleDeleteAccount = async () => {
    ...
    if (deleteConfirmUsername.toLowerCase() !== currentUser.username.toLowerCase()) {
    ...
    try {
      const response = await fetch('/api/user/delete-account', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ confirmUsername: deleteConfirmUsername }),
      });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 md:pl-20 pt-4 md:py-12 px-4 pb-24 md:pb-8 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto space-y-6 relative z-10">
        ...
        <div className="border-t border-red-500/20 pt-8 mt-4">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-gradient-to-b from-neutral-900 to-black border border-red-500/30 rounded-2xl max-w-md w-full shadow-2xl">
            ...
            <div className="p-4 space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-white mb-2">
                  Type <span className="text-cyan-400 font-bold">{currentUser?.username}</span> to confirm
                </label>
                <input
                  type="text"
                  ...
                  disabled={deleting}
                  className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-red-500/50 disabled:opacity-50"
                />
              </div>
            ...
            <div className="p-4 border-t border-white/10 flex gap-3">
              ...
              <button
                ...
                disabled={deleting || deleteConfirmUsername.toLowerCase() !== currentUser?.username?.toLowerCase()}
