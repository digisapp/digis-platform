  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      <div className="max-w-md w-full text-center">
        ...
        <p className="text-gray-400 mb-6">Something went wrong loading the admin panel.</p>
        <div className="flex gap-3 justify-center">
          ...
          <Link href="/admin" className="px-6 py-3 bg-white/10 text-white rounded-lg hover:bg-white/20 transition-colors">
            Admin Home
          </Link>
        </div>
      </div>
