  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full text-center">
        ...
        <p className="text-gray-400 mb-6">Something went wrong loading this profile.</p>
        <div className="flex gap-3 justify-center">
          ...
          <Link href="/explore" className="px-6 py-3 bg-white/10 text-white rounded-lg hover:bg-white/20 transition-colors">
            Explore Creators
          </Link>
        </div>
      </div>
