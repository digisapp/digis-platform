          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-1.5 flex-wrap mt-3 mb-1">
              <button
                ...
                className={`px-3 py-1 rounded-full font-medium text-[11px] transition-all duration-300 disabled:opacity-50 ${
                  isFollowing
              ...
              {user.role === 'creator' && subscriptionTier && !isSubscribed && (
                <button
                  ...
                  className={`px-3 py-1 rounded-full font-medium text-[11px] transition-all duration-300 bg-gradient-to-r from-purple-500 to-pink-500 text-white shadow-sm shadow-purple-500/30 ${
            ...
            {profile.socialLinks && (
              <div className="flex items-center gap-3 mt-3">
                {profile.socialLinks.instagram && (
                  <a href={`https://instagram.com/${profile.socialLinks.instagram.replace(/\s+/g, '')}`} target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-white hover:scale-110 transition-all" title={`@${profile.socialLinks.instagram}`}>
