              ...
              {userRole === 'creator' && (
                <>
                  ...
                  >
                    ...
                    <span className="text-base md:text-sm text-white font-semibold">Upload Content</span>
                  </button>
                  ...
                  >
                    ...
                    <span className="text-base md:text-sm text-white font-semibold">Content Studio</span>
                  </button>
                  ...
                  >
                    ...
                    <span className="text-base md:text-sm text-white font-semibold">Ticketed Streams</span>
                  </button>
