      ...
      >
        {token && serverUrl ? (
          <>
            ...
            <div className="absolute top-3 left-3 right-20 md:right-3 flex items-center gap-2 flex-wrap z-10">
            ...
            {activePoll && activePoll.isActive && (
              <div className="absolute bottom-36 md:bottom-20 left-3 z-[60] w-[180px] sm:w-[260px]">
                <StreamPoll
                  poll={activePoll}
                  isBroadcaster={true}
                  streamId={streamId}
            ...
            {activeCountdown && activeCountdown.isActive && (
              <div className="absolute bottom-20 right-3 z-[60] w-[180px]">
                <StreamCountdown
