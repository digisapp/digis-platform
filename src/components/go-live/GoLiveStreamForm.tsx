...
export function GoLiveStreamForm({
  ...
  // Count how many advanced settings are active
  const advancedCount = [
    tags.length > 0,
    aiChatModEnabled,
    goPrivateEnabled,
  ...
  return (
    <div className="backdrop-blur-2xl bg-gradient-to-br from-black/40 via-gray-900/60 to-black/40 rounded-2xl border-2 border-cyan-500/30 p-6 md:p-8 space-y-3 md:space-y-4 hover:border-cyan-500/50 transition-all duration-300 shadow-[0_0_30px_rgba(34,211,238,0.15)]">
      ...
      <button
        ...
        className="w-full flex items-center justify-between py-3 px-1 text-sm text-gray-400 hover:text-white transition-colors"
      >
      ...
      {showAdvanced && (
        <div className="space-y-3 md:space-y-4 pt-1 border-t border-white/5">
          {/* Tags */}
          <div>
            <label className="block text-sm font-semibold text-white mb-2">
