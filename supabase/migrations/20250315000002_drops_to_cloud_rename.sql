...
-- Current state: tables are drops_*, type enums are drops_*, wallet enums are still hub_*
...
-- ─── Rename wallet transaction type enum values (from hub_* to cloud_*) ─────

ALTER TYPE transaction_type RENAME VALUE 'hub_purchase' TO 'cloud_purchase';
ALTER TYPE transaction_type RENAME VALUE 'hub_earnings' TO 'cloud_earnings';
ALTER TYPE transaction_type RENAME VALUE 'hub_pack_purchase' TO 'cloud_pack_purchase';
ALTER TYPE transaction_type RENAME VALUE 'hub_pack_earnings' TO 'cloud_pack_earnings';
ALTER TYPE transaction_type RENAME VALUE 'hub_locked_message' TO 'cloud_locked_message';
ALTER TYPE transaction_type RENAME VALUE 'hub_locked_message_earnings' TO 'cloud_locked_message_earnings';

-- Also add 'promo_credit' if it doesn't exist (referenced in schema but may be missing)
-- DO $$ BEGIN ALTER TYPE transaction_type ADD VALUE IF NOT EXISTS 'promo_credit'; EXCEPTION WHEN duplicate_object THEN NULL; END $$;
